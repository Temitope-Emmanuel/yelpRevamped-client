...
export function AddComment(comment){
    return (dispatch,getState) => {
        ...
        return new Promise((resolve,reject) => {
            return apiCall("post",`https://yelpcamp-server.herokuapp.com/api/campground/${campId}/comment`,{...comment,user,Date:Date.now()}).then(
                response => {
...
export function deleteComment(commentId){
    return (dispatch,getState) => {
        ...
        return new Promise((resolve,reject) => {
            return apiCall("delete",`https://yelpcamp-server.herokuapp.com/api/campground/${campId}/comment/${commentId}`).then(
                response => {
